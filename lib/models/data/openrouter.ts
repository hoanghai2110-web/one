...
// Helper function to create the OpenRouter SDK with API key management
const createOpenRouterSdk = (modelName: string) => (apiKey?: string) =>
  createOpenRouter({
...
export const openrouterModels: ModelConfig[] = [
  {
    ...
    icon: "deepseek",
    apiSdk: createOpenRouterSdk("deepseek/deepseek-r1:free"),
  },
  {
    ...
    icon: "claude",
    apiSdk: createOpenRouterSdk("anthropic/claude-sonnet-4"),
  },
  {
    ...
    icon: "claude",
    apiSdk: createOpenRouterSdk("anthropic/claude-3.7-sonnet:thinking"),
  },
  {
    ...
    icon: "gemini",
    apiSdk: createOpenRouterSdk("google/gemini-2.0-flash-exp:free"),
  },
  {
    ...
    icon: "openai",
    apiSdk: createOpenRouterSdk("openai/gpt-4.1"),
  },
  {
    ...
    releasedAt: "2025-04-01",
    icon: "openai",
    apiSdk: createOpenRouterSdk("openai/o4-mini"),
  },
  {
    ...
    icon: "xai",
    apiSdk: createOpenRouterSdk("x-ai/grok-3-mini-beta"),
  },
  {
    ...
    icon: "gemini",
    apiSdk: createOpenRouterSdk("google/gemini-2.5-flash-preview-05-20"),
  },
  {
    ...
    releasedAt: "2025-04-01",
    icon: "meta",
    apiSdk: createOpenRouterSdk("meta-llama/llama-3.3-8b-instruct:free"),
  },
  {
    ...
    releasedAt: "2025-04-14",
    icon: "openai",
    apiSdk: createOpenRouterSdk("openai/gpt-4.1-mini"),
  },
  {
    ...
    releasedAt: "2025-04-14",
    icon: "openai",
    apiSdk: createOpenRouterSdk("openai/gpt-4.1-nano"),
  },
  {
    ...
    releasedAt: "2025-04-01",
    icon: "openai",
    apiSdk: createOpenRouterSdk("openai/o3-mini"),
  },
  {
    ...
    icon: "claude",
    apiSdk: createOpenRouterSdk("anthropic/claude-3.5-sonnet"),
  },
  {
    ...
    icon: "gemini",
    apiSdk: createOpenRouterSdk("google/gemini-2.0-flash-001"),
  },
  {
    ...
    releasedAt: "2024-12-11",
    icon: "gemini",
    apiSdk: createOpenRouterSdk("google/gemini-2.0-flash-lite-001"),
  },
  {
    ...
    icon: "openai",
    apiSdk: createOpenRouterSdk("openai/gpt-4.5-preview"),
  },
]