  ...
  return (
    <div
      className={cn(
        ...
        showOnboarding ? "items-center justify-center" : "items-center justify-end md:justify-center"
      )}
    >
      ...
      {showOnboarding ? (
        ...
        <>
          ...
          <motion.div
            className={cn(
              "relative inset-x-0 bottom-0 z-50 mx-auto w-full max-w-3xl px-0 sm:px-0 md:px-0"
            )}
            layout="position"
