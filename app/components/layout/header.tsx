                ...
                <AppInfoTrigger
                  trigger={
                    <Button
                      variant="ghost"
                      size="icon"
                      className="bg-background hover:bg-muted text-muted-foreground h-8 w-8 rounded-full pointer-events-auto"
          ...
          {!isLoggedIn ? (
            <div className="pointer-events-auto flex flex-1 items-center justify-end gap-3">
              <Button
                variant="ghost"
                size="sm"
                className="text-gray-600 hover:text-gray-800 hover:bg-gray-100 rounded-lg px-3 py-1.5 text-sm font-medium"
                asChild
              >
                <Link href="/auth">
                  Đăng nhập
              ...
              <Button
                size="sm"
                className="bg-black hover:bg-gray-800 text-white rounded-lg px-4 py-1.5 text-sm font-medium"
                asChild
              >
                <Link href="/auth">
                  Đăng ký
